...
export function usersThunkFetch(userString: string, gamemode: number): ThunkAction<void, StoreState, null, Action> {
    return async function(dispatch, getState) {
        ...
        try {
            ...
            const usersResponse = await axios.get(`/api/profiles/users/${userString}/stats/${gamemode}`, {
                params: {
            ...
            const scoresResponse = await axios.get(`/api/profiles/users/${osuUser.id}/stats/${gamemode}/scores`);
