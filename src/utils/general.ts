...
export function setCssCustomProperties(colours: Record<string, string>, prefix = "colours") {
...
export function clearCssCustomProperties(colours: Record<string, string>, prefix = "colours") {
    const root = document.documentElement;
